...
describe 'wsusserver' do
  context 'with default values for all parameters' do
    ...
    it {
      is_expected.to contain_class('wsusserver::install').with(package_ensure: 'present',
    ...
    it {
      is_expected.to contain_class('wsusserver::config').with(join_improvement_program: true,
